...
export const Html5QrcodePlugin = ({verbose, onQrCodeSuccess, onQrCodeError, config} : Html5QrCodePluginProps) => {
    useEffect(() => {
        const QrCodeScanner = new Html5QrcodeScanner(qrcodeRegionId, config, verbose);
